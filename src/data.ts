...
export const seedData: AppData = {
  ...
  inventory: [
    ...
    { id: 'shorts-pt-m', name: 'Navy PT Shorts', category: 'PT Gear', sizes: ['Small', 'Medium', 'Large', 'X-Large'], size: 'Medium', niin: '8415-EX-1002', onHand: 8, issued: 21, reorderAt: 10, countBy: 1, status: 'Low' },
    { id: 'shirt-nsu-m', name: 'Khaki NSU Shirt', category: 'NSU', sizes: ['Small Classic', 'Medium Classic', 'Large Classic'], size: 'Medium Classic', niin: '8415-EX-2041', onHand: 16, issued: 12, reorderAt: 6, countBy: 1, status: 'Healthy' },
    ...
    { id: 'undershirt-l', name: 'White Undershirt', category: 'Basics', sizes: ['Small', 'Medium', 'Large', 'X-Large'], size: 'Large', niin: '8420-EX-4102', onHand: 32, issued: 9, countBy: 5, status: 'Healthy' },
  ],
  cadets: [
  ...
  stillNeeded: [
    { id: 'need-shoes-am', cadetId: 'cadet-am', itemId: 'shoes-10r', requiredSize: '10 Regular', quantity: 1, firstNeededAt: '2026-08-19T00:00:00.000Z' },
    { id: 'need-shorts-ts', cadetId: 'cadet-ts', itemId: 'shorts-pt-m', requiredSize: 'Medium', quantity: 1, firstNeededAt: '2026-09-03T00:00:00.000Z' },
  ],
